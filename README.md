# Upsell Signal Scout
Detect upsell and expansion signals from product usage and account activity.
Part of the [Zion Tech Group App Network](https://github.com/Zion-support/zion-app-network) — 708 interconnected AI apps.

- 🌐 Live: https://ziontechgroup.com/upsell-signal-scout/
...
## Features
- Expansion-signal detection (seat growth, feature adoption, usage ceilings)
- Ranked opportunity feed with revenue estimates
- One-click handoff to sales playbooks
